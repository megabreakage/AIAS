...
Create a completly featured *Tenant-Scoped* **Checklist** module with the following table columns:
...
Create comprehensive *Unit & Feature Tests* for **Checklist** module covering, its model, migration, repository, service(if exists), policy, controller, requests & validations, and API resource & collection. Update Postman collection with endpoints for **Checklist** module, and ensure that all endpoints are properly documented with request and response examples.
